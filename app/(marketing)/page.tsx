  ...
  return (
    <>
        <section className="pt-6 md:pt-10 lg:py-32 pb-8 md:pb-12">
          ...
          flex flex-col items-center gap-4 max-w-[64rem]">
            <Link 
              href={siteConfig.links.x} 
              className="bg-muted px-4 py-1.5 rounded-2xl"
            >
              Xをフォローする
            </Link>
            <h1 className="font-extrabold text-3xl sm:text-5xl lg:text-7xl">Post Writer</h1>
            <p className="text-muted-foreground sm:text-xl leading-normal max-w-[42rem]">このアプリケーションはNext.js
              App Routerで作られたものです。ユーザーは自由に投稿をポストすることができます。
            </p>
        ...
        <section 
          id="features" 
          className="py-8 md:py-12 lg:py-24 bg-slate-50 w-full  mx-auto px-5 space-y-6"
        >
          <div className="container text-center space-y-6 max-w-[58rem] mx-auto">
            <h2 className="font-extrabold text-3xl md:text-6xl">
              サービスの特徴
            </h2>
            <p className="text-muted-foreground sm:text-lg sm:leading-7">
              このプロジェクトはモダンな技術スタックを使って作られたWebアプリケーションです。<br/>Next.js AppRouterやcontetlayerを利用してマークダウン形式でブログ投稿できます。
            </p>
          </div>
          ...
          <div className="mx-auto grid sm:grid-cols-2 md:grid-cols-3 gap-4 max-w-[64rem]">
            ...
            <div className="bg-background border p-2 rounded-lg">
              <div className="flex flex-col justify-between p-6 h-[180px]">
                <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" viewBox="0 0 24 24"><path fill="#000000" d="M21.98 7.448L19.62 0H4.347L2.02 7.448c-1.352 4.312.03 9.206 3.815 12.015L12.007 24l6.157-4.552c3.755-2.81 5.182-7.688 3.815-12.015l-6.16 4.58l2.343 7.45l-6.157-4.597l-6.158 4.58l2.358-7.433l-6.188-4.55l7.63-.045L12.008 0l2.356 7.404l7.615.044z"/></svg>
                <div className="space-y-2">
          ...
          <div className="text-center md:max-w-[58rem] mx-auto">
            <p className="text-muted-foreground sm:text-lg  sm:leading-7">Post Writerはログインするとブログ投稿できるようになります。</p>
          </div>
        </section>

        <section id="contact" className="mx-auto container py-8 md:py-12 lg:py-24">
